...
def slice_on_vad(path: str, slice_length_s: float) -> list[AudioPart]:
    """
    ...
    for seg in speech_ts:
        ...
        if speech_end - chunk_start >= target_samples:
...
def slicer(file_path: str | Path, slice_length_s: float) -> list[AudioPart]:
    """
    ...
    parts = slice_on_vad(path_str, slice_length_s)
